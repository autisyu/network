...
void QuadTreeClass::Render(FrustumClass* frustum, ID3D10Device* device, TerrainShaderClass* shader)
{
...
void QuadTreeClass::RenderNode(NodeType* node, FrustumClass* frustum, ID3D10Device* device, TerrainShaderClass* shader)
{
	bool result;
